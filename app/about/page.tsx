...
export const metadata: Metadata = {
  title:
    "About Satinder Singh Sall — Founder & Developer of FinTrack | By - Satinder Singh Sall",

  description:
    "Learn about Satinder Singh Sall, the developer and founder behind FinTrack. Explore his full-stack development work across React, Next.js, React Native, Node.js, MongoDB, and modern digital products.",

  keywords: [
    "Satinder Singh Sall",
    "Satinder Singh Sall developer",
    "Satinder Singh Sall software developer",
    "Satinder Singh Sall full stack developer",
    "Satinder Singh Sall React developer",
    "Satinder Singh Sall React Native developer",
    "Satinder Singh Sall Next.js developer",
    "FinTrack developer",
    "FinTrack founder",
  ...
  openGraph: {
    title: "About Satinder Singh Sall — Founder & Developer of FinTrack",

    description:
      "Meet Satinder Singh Sall, the developer and founder behind FinTrack, a modern personal finance application built with modern web, mobile, and backend technologies.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Satinder Singh Sall — Founder and Developer of FinTrack",
      },
    ],
  },
  ...
  twitter: {
    ...
    description:
      "Learn about Satinder Singh Sall, the developer and founder behind FinTrack.",
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "Person",
      "@id": `${SITE_URL}/#satinder-singh-sall`,
      name: DEVELOPER_NAME,
      url: DEVELOPER_URL,
      jobTitle: "Software Developer",
      image: `${SITE_URL}/images/about-image4.jpeg`,
      sameAs: [
        ...
        "https://www.facebook.com/satinder.singhsall",
        "https://www.instagram.com/satindersinghsall",
      ],
      knowsAbout: [
...

    {
      ...
      url: `${SITE_URL}/about`,
      name: "About Satinder Singh Sall — Founder & Developer of FinTrack",
      description:
        "About Satinder Singh Sall, the developer and founder behind FinTrack.",
      isPartOf: {
        "@id": `${SITE_URL}/#website`,
      },
      about: {
              ...
              <div className="relative w-full max-w-[520px]">
                ...
                >
                  <Image
                    ...
                    alt="FinTrack personal finance mobile app"
                    width={400}
                    height={400}
              ...
              <div className="space-y-5">
                <div className="overflow-hidden rounded-[32px] shadow-xl">
                  <Image
                    ...
                    alt="Satinder Singh Sall software development workspace"
                    width={600}
                    height={700}
                ...
                <div className="overflow-hidden rounded-[32px] shadow-xl">
                  <Image
                    ...
                    alt="Satinder Singh Sall development and creative workspace"
                    width={600}
                    height={700}
                    className="h-full w-full object-cover hover:scale-105 transition-transform duration-700"
                  />
              ...
              <div className="space-y-5 pt-10">
                <div className="overflow-hidden rounded-[32px] shadow-xl">
                  <Image
                    ...
                    alt="Satinder Singh Sall workspace"
                    width={600}
                    height={700}
                    className="h-full w-full object-cover hover:scale-105 transition-transform duration-700"
                  />
                ...
                <div className="overflow-hidden rounded-[32px] shadow-xl">
                  <Image
                    src="/images/about-image4.jpeg"
                    alt="Satinder Singh Sall developer portrait"
                    width={600}
                    height={700}
                    className="h-full w-full object-cover hover:scale-105 transition-transform duration-700"
                  />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-6 text-lg text-zinc-600 leading-relaxed">
                ...
                scratch — combining mobile engineering, scalable backend
                systems, and modern web experiences into one production-grade
                platform.
              </p>
            </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="mt-5 max-w-3xl mx-auto text-lg text-zinc-600 leading-relaxed">
                ...
                precision to create a premium digital experience that feels
                fast, modern, and meaningful.
              </p>
            </div>
          </div>
        </section>
